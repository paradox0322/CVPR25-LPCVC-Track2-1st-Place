...
def register_all_coco_panoptic_annos_caption_grounding_sem_seg(root):
    for (
        ...
        prefix_instances = '_'.join(prefix.split('_')[0:3])
        instances_meta = MetadataCatalog.get(prefix_instances)
        image_root = "/seu_nvme/datasets/open/coco/train2017"  # ???? image_root
        instances_json = instances_meta.json_file

        # ???????? root ??
        panoptic_root = "/seu_nvme/home/zhangmeng/220246538/zzt/datasets/coco/panoptic_train2017"
        panoptic_json = os.path.join(root, panoptic_json)
        semantic_root = "/seu_nvme/home/zhangmeng/220246538/zzt/datasets/coco/panoptic_semseg_train2017"
        caption_root = os.path.join(root, caption_root)
        grounding_root = os.path.join(root, grounding_root)
        similarity_pth = os.path.join(root, similarity_pth)

        # ????????
        # print("Image root:", image_root)
        # print("Panoptic root:", panoptic_root)
        # print("Panoptic JSON:", panoptic_json)
        # print("Semantic root:", semantic_root)
        # print("Caption root:", caption_root)
        # print("Grounding root:", grounding_root)
        # print("Similarity pth:", similarity_pth)
