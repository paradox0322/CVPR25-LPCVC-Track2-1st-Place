...
def get_metadata(name):
    if name in ['vlp_captioning_val', 'vlp_captioning_val2017']:
        return {'gt_json': '/seu_nvme/home/zhangmeng/220246538/zzt/datasets/coco/annotations/captions_val2014.json'}
    else:
        return {}
...
def register_all_pretrain(root):
    for (
        ...
        root='/seu_nvme/home/zhangmeng/220246538/zzt/datasets'
